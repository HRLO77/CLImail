...
class User:
    ...
    def __eq__(self, other):
        return self.email == other.email and self.password == other.password and self.port == other.port and isinstance(other, self.__class__) # dunno why I added this function
    ...
    def __init__(self, password: str, user: str):
        ...
        if user.endswith('@gmail.com'):
            ...
            self.smtp_server = smtplib.SMTP_SSL('smtp.gmail.com', 465, context=context) # spent two hours here only to find i made a typo :/
            ...
            raise TypeError("CLImail only supports gmail accounts.")
    ...
    def subscribe(self, mailbox: str): # and don't forget to hit that like button and click the notificaion bell for more!
        '''
    ...
    def mail_from_id(self, id: str):
        ...
        '''
        return email.message_from_bytes(self.imap_server.fetch(str(id), '(RFC822)')[1][0][1]) # I hate working with bytes
